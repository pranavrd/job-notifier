...
export const ASHBY = [
  ...
  //     Generic single-word tokens (atlas, vector, twenty, phoenix, titan, pure, sphere)
  //     were left out: the board behind such a token can't be confidently tied to the
  //     H-1B-verified company, and pretty() would mislabel it.
  "rescale", "influxdata", "cambly", "eightsleep", "gecko-robotics", "classdojo", "mednet",
  "prelim", "overview", "middesk", "ashby", "bunkerhillhealth", "trm-labs",
  "vorticity", "accord", "paragon", "roboflow", "blissway", "notabene", "flint", "taktile",
  "fieldguide", "axle-health", "vapi", "flutterflow", "odys-aviation", "tavus",
  "kodex", "aleph", "zensors", "stepful", "nash", "sieve", "mintlify", "eventual",
  "realitydefender", "chariot", "ekho", "aiprise", "knowtex", "cambio", "latent", "tennr",
  "vooma", "pylon", "automat", "hockeystack", "electricair", "campfire",
  "fleetworks", "sola", "sweep", "reducto", "garage", "pointone", "furtherai",
